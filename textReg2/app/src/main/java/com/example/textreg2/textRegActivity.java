...
//                .build();
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void v) {
                                ...
                                startTranslate(englishGermanTranslator,mResultEt.getText().toString());
                            }
                        })
    ...
    private void startTranslate(Translator englishGermanTranslator, String toString) {
        englishGermanTranslator.translate(toString)
                .addOnSuccessListener(
